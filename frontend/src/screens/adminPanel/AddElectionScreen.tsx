...
type NavigationProp = StackNavigationProp<RootStackParamList, "AddElection">;
...
const AddElectionScreen: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${API_BASE_URL}/api/elections`, {
        ...
        // Default empty arrays for candidates and provinces
        candidates: [],
        provinces: []
      });
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Add Election</Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <TouchableOpacity
            ...
            accessibilityLabel={loading ? "Adding election, please wait" : "Add election"}
          >
            {loading ? (
